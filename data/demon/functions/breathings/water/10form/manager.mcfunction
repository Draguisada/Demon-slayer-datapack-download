...
scoreboard players set @s ds_10form 300
...
execute as @s run scoreboard players set @s ds_cooldown 450
scoreboard players set @a[scores={ds_detectclick=1..}] detectclick 0
