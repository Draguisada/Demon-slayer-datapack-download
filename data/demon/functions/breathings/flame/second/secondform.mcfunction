...
execute positioned ^ ^1 ^1 run tag @e[tag=!flameform,type=!#demon:nokill,distance=..1.5] add 2ff
execute as @e[tag=2ff,type=!#demon:nokill] at @s run damage @s 25 minecraft:player_attack by @a[tag=flameform,limit=1,sort=nearest]
